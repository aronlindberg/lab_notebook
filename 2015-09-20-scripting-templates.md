# Scripting templates
To make the work for research assistants within the lab easier I need to provide a number of templates for standard tasks. All of this will be based on the code style guide (http://adv-r.had.co.nz/Style.html). This would involve things such as:
